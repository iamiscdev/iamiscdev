...
- 💻 Recent projects:
-   [SnapAlert](https://github.com/iamiscdev/snapalert) — Community safety incident reporting platform with Supabase auth, real-time dashboard, and barangay/city jurisdiction isolation, a DevKada Projects
-   [CyberGuard](https://github.com/iamiscdev/cyberguard) (rule-based cybersecurity expert system), Rule Builder (Flutter/Firebase), and CardConnect.
